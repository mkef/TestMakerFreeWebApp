...
namespace TestMakerFreeWebApp.Data
{
    public class DbSeeder
    {
        ...
        private static void CreateQuizzes(ApplicationDbContext dbContext)
        {
            ...
            EntityEntry<Quiz> e1 = dbContext.Quizzes.Add(
                new Quiz()
                {
                    UserId = authorId,
    ...
    "Unveil your true self with this Attack On Titan personality test!",
        ...
        )
        {
            var quiz = new Quiz()
            {
                ...
                Text = "This is a sample quiz created by the DbSeeder class for testing purposes. " + "All the questions, answers & results are autogenerated as well.",
                ViewCount = viewCount,
                CreatedDate = createdDate,
